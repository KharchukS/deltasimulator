...
* **How can I contribute to Deltasimulator?** 
  ...
  * If you found a bug: We would be ever so grateful if it create a
    `GitHub Issue <https://github.com/riverlane/deltasimulator/issues>`_.

  * If you want to contribute to Deltasimulator: Please follow this simple 
